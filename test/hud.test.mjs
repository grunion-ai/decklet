...
test('hud: the buttons run navigate · save state · edit · file · view, in that order, with a divider between groups', () => {
  ...
  assert.deepEqual(ids, ['prev', 'next', 'autosave', 'addbtn', 'dup', 'snap', 'spell', 'spellbad', 'savecopy', 'pdf', 'grid-btn', 'fs', 'help', 'bug'], 'the count badge is a button of its own, on the toggle');
