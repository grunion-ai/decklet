...
**Try it live:** https://grunion-ai.github.io/decklet/deck.html (drag, retype, ⊞ contact sheet, ⤓ PDF, F fullscreen). **The template pack:** https://grunion-ai.github.io/decklet/library.html — every template and layout the engine ships (99 + 22), one per slide, grouped by the kind of slide it is, then six of them under the eleven style kits in `examples/styles`. Two cuts of the same pack open faster: [library-speaker.html](https://grunion-ai.github.io/decklet/library-speaker.html) and [library-reading.html](https://grunion-ai.github.io/decklet/library-reading.html) carry only the slides of one density, under three orthogonal kits. If decklet builds you a deck, star the repo: stars are how agents and people find it.
...
bin/new.mjs          a starter model + MANIFEST.md — validate/verify clean before you edit it
