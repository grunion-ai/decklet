...
function rowsOf(spec, frame) {
  ...
  (spec.edges || []).forEach((e, i, all) => {
    ...
    if (pts.length === 2) {
      ...
      else if (fits(p3[0] - p0[0], e.label)) lbl(e.label, Math.round(X(p1[0]) - w / 2) - 4, Y((p1[1] + p2[1]) / 2) - 8, w, group, chip);   // centred on the vertical: the halo covers the line and the chip stays between the nodes
