...
export const DENSE = {
  subtitle: {x: M, y: 118, w: CW, role: 'H2', color: 'var(--muted)'},                 // the claim in one sentence, under the H1
  note:     {x: M, y: 428, w: 700, role: 'Body', color: 'var(--muted)'},              // what to make of the figure — one or two lines
  source:   {x: M, y: 470, w: 560, role: 'Caption'},                                   // where the numbers came from, left foot
  legend:   {right: M, y: 470, w: 'auto', role: 'Label', nowrap: 1},                   // series or symbol key, right foot
};
export const LIBRARY = {
  ...
  'image-left': {group: 'visuals', density: 'reading', use: 'Pair an image on the left with a title and text on the right.',
    ...
    dense: {subtitle: {x: 500, y: 206, w: 400, role: 'H2', color: 'var(--muted)'}, note: {x: 500, y: 400, w: 400, role: 'Body', color: 'var(--muted)'}, source: {x: M, y: 476, w: 560, role: 'Caption'}, legend: {right: M, y: 476, w: 'auto', role: 'Label', nowrap: 1}}},
  'image-right': {group: 'visuals', density: 'reading', use: 'Pair a title and text on the left with an image on the right.',
    ...
    dense: {subtitle: {x: M, y: 206, w: 400, role: 'H2', color: 'var(--muted)'}, note: {x: M, y: 400, w: 400, role: 'Body', color: 'var(--muted)'}, source: {x: M, y: 476, w: 560, role: 'Caption'}, legend: {right: M, y: 476, w: 'auto', role: 'Label', nowrap: 1}}},
  // ── numbers
  ...
  chart:   {group: 'numbers', density: 'reading', use: 'Plot one series (a chart row in the chart slot), then say the takeaway and the source.',
    slots: {...head, chart: {x: M, y: 150, w: CW, h: 262}, takeaway: {x: M, y: 424, w: CW, role: 'Body'}, source: {x: M, y: 458, w: 560, role: 'Caption'}},
    dense: {note: false, legend: {right: M, y: 458, w: 'auto', role: 'Label', nowrap: 1}}},   // takeaway is the note; the media moved down 14px to seat the subtitle
