...
export const LIBRARY = {
  ...
  cta:     {group: 'closers', density: 'speaker', use: 'Ask for the one next step, with a painted button that carries the link.',
    slots: {title: {x: M, y: 150, w: CW, role: 'Title'}, body: {x: M, y: 320, w: 700, role: 'Body'}, button: {x: M, y: 400, w: 260, h: 48, bg: 'var(--accent)', radius: 8, group: 'button'}, 'button-label': {x: M, y: 412, w: 260, role: 'Body', align: 'center', weight: 600, color: 'var(--card)', group: 'button'}}},
