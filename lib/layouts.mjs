...
export const LIBRARY = {
  ...
  'image-left': {group: 'visuals', density: 'reading', use: 'Pair an image on the left with a title and text on the right.',
    ...
    dense: {subtitle: {x: 500, y: 250, w: 400, role: 'H2', color: 'var(--muted)', nowrap: 1}, note: {x: 500, y: 400, w: 400, role: 'Body', color: 'var(--muted)'}, source: {x: M, y: 476, w: 500, role: 'Caption'}, legend: {right: LEGEND_R, y: 476, w: 'auto', role: 'Label', nowrap: 1}}},
  'image-right': {group: 'visuals', density: 'reading', use: 'Pair a title and text on the left with an image on the right.',
    ...
    dense: {subtitle: {x: M, y: 250, w: 400, role: 'H2', color: 'var(--muted)', nowrap: 1}, note: {x: M, y: 400, w: 400, role: 'Body', color: 'var(--muted)'}, source: {x: M, y: 476, w: 500, role: 'Caption'}, legend: {right: LEGEND_R, y: 476, w: 'auto', role: 'Label', nowrap: 1}}},
