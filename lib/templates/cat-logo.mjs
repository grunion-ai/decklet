...
{ id: 'logo-foot-mark', name: 'Foot mark', tier: 'core', cat: 'Logo', density: 'reading',
  note: 'A small mark ahead of the source line, sharing the foot band with the page counter.', layout: 'content',
  els: [ { slot: 'supertitle', text: 'Logo · foot' }, { slot: 'title', text: 'Down in the band with the counter.' },
    ...
    ...MARKS.halcyon(M, 452, 18), word(M + 26, 456, 160, 'Halcyon', { color: S2 }) ] },
...
{ id: 'logo-rail-mark', name: 'Mark in the rail', tier: 'standard', cat: 'Logo', density: 'reading',
  note: 'The mark rides a tinted edge rail, in the card colour, clear of the canvas.', layout: null,
