...
// a photo and three short points beside it: the `image-left` layout's b1…b4, not its `body` paragraph. Keep each point under
// about forty-five characters — the column is 364px and a point that wraps runs into the one below it.
{ id: 'image-bullets', name: 'Image + points', tier: 'core', cat: 'Modern', note: 'A photo on the left, three short points beside it, each with its dot.', layout: 'image-left',
  els: [ { slot: 'image', bg: 'linear-gradient(135deg,var(--box),var(--line))', radius: 10 },
    { slot: 'supertitle', text: 'The runner' }, { slot: 'title', text: 'Built for the hour before work.' },
    { slot: 'b1', text: 'Most runs start before half past six.' },
    { slot: 'b2', text: 'A median run is thirty-four minutes.' },
    { slot: 'b3', text: 'One buzz a mile, and no screen to read.' },
    { slot: 'source', text: 'Source · Stride activity log, twelve months' } ] },
