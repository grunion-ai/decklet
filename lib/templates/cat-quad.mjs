...
{ id: 'quad-effort-impact', tier: 'core', density: 'reading', name: 'Effort / impact with chips', cat: 'Quad', note: 'Items sit as named chips, not dots. No legend to cross-reference.', layout: 'content', hideFoot: 1,
...
{ id: 'quad-stakeholder', tier: 'standard', density: 'reading', name: 'Stakeholder map with actions', cat: 'Quad', note: 'Each quadrant names the action, not the category. The most useful 2×2 in a working session.', layout: 'content', hideFoot: 1,
...
{ id: 'quad-where-we-play', tier: 'core', density: 'speaker', name: 'One quadrant lit', cat: 'Quad', note: 'Three quadrants muted, one owned. Use when the slide is a recommendation, not a survey.', layout: 'content', hideFoot: 1,
...
{ id: 'quad-conceptual', tier: 'core', density: 'reading', name: 'Conceptual 2×2, no data', cat: 'Quad', note: 'Four ideas, one line each, no plotted points. A framework slide, not a chart.', layout: 'content', hideFoot: 1,
