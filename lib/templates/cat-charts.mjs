...
{ id: 'chart-column', name: 'Column chart — one series', tier: 'core', cat: 'Charts', note: 'Bars on a baseline, values above, periods below. The default chart.', layout: 'content',
  els: [ { slot: 'supertitle', text: 'Revenue' }, { slot: 'title', text: 'Four quarters, one direction.' },
    ...
    lab(M, 432, 300, 'Recognised revenue · $000s') ] },   // clear of the category labels' line boxes
...
{ id: 'chart-scatter', name: 'Scatter / bubble — two variables', tier: 'standard', cat: 'Charts', note: 'Position for two variables, size for a third, labels only on outliers.', layout: 'content',
  els: [ { slot: 'supertitle', text: 'Accounts' }, { slot: 'title', text: 'Volume and margin are not the same book.' },
    ...
    dot(540, 260, 46, { bg: S1 }), lab(576, 236, 80, 'Kessler', { color: S1, nowrap: 1 }),   // the box ends before the next bubble
...
{ id: 'chart-flow-split', name: 'Flow split — volume in, volume out', tier: 'fringe', cat: 'Charts', note: 'Band thickness is volume. The ribbons are one svg row (cubic fills, token colours); nodes and labels stay rows.', layout: 'content',
  els: [ { slot: 'supertitle', text: 'Flow' }, { slot: 'title', text: 'Most of what arrives never gets underwritten.' },
    // nodes: submitted 1,240 = 220px; underwritten 640 = 114px; dropped 600 = 106px. Ribbons: source split at 190+114 = 304.
    rect(M + 20, 190, 40, 220, { bg: 'var(--fg)' }), lab(M + 20, 168, 160, 'Submitted · 1,240', { nowrap: 1 }),
    rect(820, 190, 40, 114, { bg: 'var(--accent)' }), lab(700, 168, 160, 'Underwritten · 640', { align: 'right', nowrap: 1 }),
    ...
    lab(400, 232, 140, '52% underwritten', { align: 'center', nowrap: 1, color: 'var(--accent)' }),
