...
{ id: 'bullet-page', name: 'Bullets — title and points', tier: 'core', cat: 'Narrative', note: 'A title and four to six points, one line each, an engine-drawn dot per point.', layout: 'bullets',
